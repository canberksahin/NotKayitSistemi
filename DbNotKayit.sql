...
/****** Object:  Database [DbNotKayıt]    Script Date: 31.03.2020 17:35:50 ******/
CREATE DATABASE [DbNotKayıt]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DbNotKayıt', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\DbNotKayıt.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DbNotKayıt_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\DbNotKayıt_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [DbNotKayıt] SET RECOVERY SIMPLE 
GO
